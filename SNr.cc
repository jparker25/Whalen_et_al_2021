...
1. Fully segregated pathways (Fig 2B-D)
...
2. Partially segregated pathways (Fig 2F-G)
...
3. Competitive architecture (Fig 3B-C, 7)
...
4. Competitive architecture in control conditions (Fig 3D)
...
3. Competitive architecture with QIF neurons (Fig 6A-B)
...
6. Competitive architecture with QIF neurons and noise (Fig 6C, along with the above model in #5)
